...
echo "Test 6: bundle documentation includes doc-lifecycle"
grep -qE "^\s*-\s*doc-lifecycle\s*$" "$BUNDLE_FILE" \
  || { echo "FAIL: doc-lifecycle not listed in documentation bundle"; exit 1; }
