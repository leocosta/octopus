...
database profiles in the picker — you confirm or deselect them before
...
| `--stack <name>` | Preselect a stack profile: `dotnet` → `stack-csharp`, `node` → `stack-typescript`, `python` → `stack-python` |
