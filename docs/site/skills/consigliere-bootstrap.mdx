...
`consigliere-bootstrap` (RM-099) stands up the foundation of the
...
The six fixed sections in every `state.md` — **Status por frente,
Impedimentos, Decisões, Mapa de sistemas/áreas, Ações, Riscos
políticos** — are the digest contract. Every claim traces back to a
