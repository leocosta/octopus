...
`/octopus:review-contracts` escaneia um branch em busca de drift entre
...
O `review-contracts` torna a comparação cross-stack automática em
cada diff.
...
[Fonte: `commands/review-contracts.md`](https://github.com/leocosta/octopus/blob/main/commands/review-contracts.md)
