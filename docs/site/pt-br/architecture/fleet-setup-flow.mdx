...
um repo ainda ganha, e a geração preenche as lacunas. Essa é a precedência
de template de config do workspace.
...
um humano — essa é a merge policy não-destrutiva da frota.
