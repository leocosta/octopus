...
![Version](https://img.shields.io/badge/version-v1.42.2-blue)
...
```bash
curl -fsSL https://github.com/leocosta/octopus/releases/latest/download/install.sh | bash -s -- --version v1.42.2
```
